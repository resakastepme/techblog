                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav justify-content-center">
                            <li class="nav-item {{ Request::is('/') ? 'active' : '' }}"><a class="nav-link"
                                    href="{{ url('/') }}">Home</a></li>
                            <li class="nav-item {{ Request::is('search') || Request::is('search-post') ? 'active' : '' }}"><a class="nav-link" href="{{ url('/search') }}">Search</a></li>
                            <li class="nav-item submenu dropdown {{ Request::is('create') || Request::is('*/view') || Request::is('*/edit') ? 'active' : '' }}">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button"
                                    aria-haspopup="true" aria-expanded="false">Post</a>
                                <ul class="dropdown-menu">
                                    <li class="nav-item"><a class="nav-link" href="{{ url('/create') }}">Create a post</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
